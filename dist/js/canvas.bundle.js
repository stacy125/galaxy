...
var colors = ['#2185C5', '#651e1e', '#b967ff', '#7ECEFD', '#4c4cff', '#FFF6E5', '#EDDE15']; // Event Listeners
...
function animate() {
  ...
  c.fillRect(0, 0, canvas.width, canvas.height); // c.fillText('Hello', mouse.x, mouse.y)
